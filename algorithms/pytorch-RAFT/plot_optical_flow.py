...
# python plot_optical_flow.py "prof" > ../../codefest/cf02/profiling/torch_results.txt
# kernprof -l -v plot_optical_flow.py > ../../codefest/cf02/profiling/line_results.txt
# remember to uncomment the @profile decorator in the main function


# @profile # NEEDS TO BE COMMENTED OUT FOR TORCH, IN FOR LINE_PROF
def main():
    # %%
