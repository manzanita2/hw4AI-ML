...
**51.2 GFLOP/s** compute roof. See `report/` for the full discussion of
why (single N-wide `result_buf` forces the reload-vs-reuse trade-off) and
what pixel-batched weight reuse would recover.
