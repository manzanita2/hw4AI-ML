...
project/m4/tb/artifacts/top.vcd, e.g.:

    cd project/m4/tb && COCOTB_TEST_FILTER=test_gemm_tile_e2e ENABLE_VCD=1 make
...
tests). Output: project/m4/sim/cosim_waveform.png
...
def main() -> None:
    ...
    fig.suptitle(
        "M4 end-to-end co-simulation: one host-driven LOAD + COMPUTE tile "
        "(test_gemm_tile_e2e, 16x16 @ 100 MHz)\n"
